...
function Add_Designer() {
  ...
  const addSketch_Url = window.url + "sketch/addSketch";
//   const sideBarState = useSelector((state) => state?.sidebar?.sideBar);
  ...
  const handleCloseModal = () => {
    setShowModal(false);
    navigate("/view_sketch_Model"); // Navigate back when modal is closed
  };
            ...
            {showModal && (
              <div className="modal-overlay">
                <div className="modal-content">
                  <h2 className="modal-title">Add Sketch Designer</h2>
