     ...
     const handlePrint = async () => {
        ...
        try {
          ...
          const orderDetails = [
            ...
            {
              key: "Sketch No",
              value: orderData.sketchNo ?orderData.sketchNo : "N/A",
            },
            {
              key: "Date",
      ...
      <Content>
          <div className="main-panel">
                <div className="vieworder-container">
                    <h4 className="vieworder-heading">{order.categoryGroup?.category_group_name}</h4>
                    ...
                    <div className="vieworder-cards">
                            ...
                            {orderData.imageUrls?.length > 0 ? (
                                <div className="image-grid">
                                    {orderData.imageUrls.map((image, index) => (
                                        <img key={index} src={image} alt={`Sketch ${index + 1}`} width="100" height="100" />
                                    ))}
                                </div>
                            ) : (
                        ...
                        <div className="vieworder-card">
                            ...
                            <p><strong>Sketch No:</strong> {orderData.sketchNo}</p>
                        ...
                        <div className="vieworder-card">
                            <h3>Metal Type</h3>
                            <p><strong>Type:</strong> {order.MetalType?.metal_type}</p>
                            <p><strong>Color:</strong> {order.MetalColor?.metal_color_name}</p>
                            <p><strong>Diamond Range:</strong> {order.diamondRange}</p>
                            <p><strong>Expected Gross Weight:</strong> {order.expectedGrossWt}</p>
                        </div>

                        {/* Product Type Card */}
                        <div className="vieworder-card">
                            <h3>Product Details</h3>
                            <p><strong>Type:</strong> {order.ProductType?.product_types}</p>
                            <p><strong>Gender:</strong> {order.Gender?.gender}</p>
                            <p><strong>Occasion:</strong> {order.Occasion?.occasion}</p>
                            <p><strong>Style:</strong> {order.Style?.style_name}</p>
                        </div>

                        {/* Customer Details Card */}
                        <div className="vieworder-card">
                            <h3>Customer Details</h3>
                            <p><strong>Name:</strong> {order.Customer?.customer_first_name}</p>
