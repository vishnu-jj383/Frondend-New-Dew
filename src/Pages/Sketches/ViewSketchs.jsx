    ...
    try {
      ...
      const addImages = async () => {
        if (orderData.imageUrls?.length > 0) {
          addSectionHeading("Sketch Images");
          const imgWidth = 50;
          const imgHeight = 50;
          const imgSpacing = 10;
      ...
      addFooter();
      pdf.save(`Sketch_${orderData.sketchNo || "Order"}.pdf`);
    } catch (error) {
          ...
          <div className="vieworder-container">
            ...
            <div className="vieworder-cards">
              ...
              <div className="vieworder-card">
                ...
                <p>
                  <strong>Sketch No:</strong> {orderData.sketchNo}
                </p>
                <p>
                ...
                <p>
                  <strong>Promise Date:</strong> {order?.promiseDate}
                </p>
              </div>
