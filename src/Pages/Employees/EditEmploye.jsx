...
function EditEmploye() {
  ...
  useEffect(() => {
    ...
    const fetchEmploye = async () => {
      try {
        ...
        setFormData({
          ...customerData,
          role: customerData.Role?.id || "", // Set role id if available
        });
        //  alert(`Fetched password: ${customerData.Role.roleName}`);
      } catch (err) {
        setErrors("Failed to fetch employee data.");
        console.error(err);
      }
    };
  ...
  const validateForm = () => {
    ...
    if (!formData.emp_subsidiary.trim())
      newErrors.emp_subsidiary = "Subsidiary is required";
          ...
          <div className="page-inner">
            ...
            <div className="card">
              <div className="card-header text-white">
                <center>
                  <h5 style={{ color: "black" }}>Edit Employee</h5>
                </center>
              </div>
                  ...
                  <div className="col-md-4">
                    <div className="form-group">
                      ...
                      <select
                        className="form-control"
                        name="role"
                        value={formData.role} // This should now match the existing role's ID
                        onChange={handleChange}
                      >
