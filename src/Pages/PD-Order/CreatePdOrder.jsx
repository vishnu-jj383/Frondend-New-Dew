              ...
              <div className="col-md-3">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    className="form-control"
                    value={
                      selectedCustomer ? `CU${selectedCustomer.id}` : "NIL"
                    }
                    disabled
                    // style={{ height: "38px", fontSize: "14px" }}
                  />
...
<br/>
              ...
              <div className="col-md-3">
                ...
                <div className="form-group">
                  <label>
                    Color Stone Range <span style={{ color: "red" }}>*</span>
                  </label>
                  <input
                    type="text"
                    className="form-control"
              ...
              <div className="col-md-3">
                <div className="form-group">
                  <label>
                    Expected Net Weight <span style={{ color: "red" }}>*</span>
                  </label>
                  <input
                    type="number"
                    className="form-control"
                ...
                <div className="form-group">
                  <label>
                    Choose Image File <span style={{ color: "red" }}>*</span>
                  </label>
                  <input
                    type="file"
                    className="form-control"
